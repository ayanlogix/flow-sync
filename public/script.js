document.addEventListener('DOMContentLoaded', () => {
    ...
    const nodeTypes = {
        stripe: { name: "Stripe Event", icon: "S", color: "#635bff", desc: "Listen for new webhooks" },
        shopify: { name: "Shopify Order", icon: "Sh", color: "#95bf47", desc: "Trigger on successful sale" },
        discord: { name: "Discord Bot", icon: "D", color: "#5865f2", desc: "Post to channel #general" },
        gmail: { name: "Gmail API", icon: "G", color: "#ea4335", desc: "Send summary email" },
        slack: { name: "Slack Connect", icon: "Sl", color: "#4a154b", desc: "Ping engineering team" }
    };
